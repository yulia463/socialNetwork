...
/*
в этом файле мы обозначаем какие роуты мы ловим в для отрисовки path={'/dialogs'} это путь
 element= это то что отрисовывать когда он совпадет
 хедер и нав всегда будут отрисовываться так как они стоят вне роутов но в нутри арр
